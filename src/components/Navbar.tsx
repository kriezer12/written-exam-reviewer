...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  // Lock body scrolling when mobile navigation portal drawer is open
  useEffect(() => {
    if (mobileMenuOpen) {
  ...
  return (
    <header style={{ position: 'sticky', top: 0, zIndex: 100 }}>
      {/* Header Top Bar with Glass Effect */}
      <div className="glass-panel" style={{ borderRadius: 0, borderTop: 'none', borderLeft: 'none', borderRight: 'none' }}>
      ...
      {/* Mobile Navigation Overlay Portal (Rendered to document.body for full-screen view) */}
      {mobileMenuOpen && createPortal(
        <div className="mobile-nav-overlay-portal">
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div>
                <h2 style={{ fontSize: '1.05rem', fontWeight: 800, color: 'var(--text-primary)', margin: 0, display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          <div style={{ padding: '20px', display: 'flex', flexDirection: 'column', gap: '16px', overflowY: 'auto', flex: 1 }}>
            ...
            <div style={{ fontSize: '0.78rem', fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.05em', marginTop: '4px' }}>
              Select Mode:
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <button
                ...
                style={{ justifyContent: 'flex-start', width: '100%', padding: '14px 18px', fontSize: '1rem' }}
              >
                <Clock size={20} />
              ...
              <button
                ...
                style={{ justifyContent: 'space-between', width: '100%', padding: '14px 18px', fontSize: '1rem' }}
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <Bookmark size={20} />
                ...
                {bookmarkedCount > 0 && (
                  <span className="badge badge-indigo" style={{ fontSize: '0.8rem', padding: '3px 8px' }}>
                    {bookmarkedCount}
                  </span>
                )}
              </button>
